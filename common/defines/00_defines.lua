...
NCountry = {
	...
	SPECIAL_FORCES_CAP_MIN = 162,					-- You can have a minimum of this many special forces battalions, regardless of the number of non-special forces battalions you have, this can also be modified by a country modifier
...
NProduction = {
	...
	BASE_FACTORY_SPEED_MIL = 3.3, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
